...
public class Tester extends BasicGame{
	...
	public ArrayList<Items> createItemPool(){
    	
    	ArrayList<Items> itemPool = new ArrayList<Items>();
    	
    	//add usable items to pool - name, class, hp, mp, resu
     	itemPool.add(new Usable("Angel's Grail", 0, 0, 0, 1));
     	itemPool.add(new Usable("Dreamsee Herb", 0, 0, 50, 0));
     	itemPool.add(new Usable("Honey Drink", 0, 50, 0, 0));
     	itemPool.add(new Usable("Magic Walnut", 0, 50, 50, 0));
     	itemPool.add(new Usable("Pakkun Chocolate", 0, 150, 150, 0));
     	itemPool.add(new Usable("Pui Pui Grass", 0, 25, 0, 0));
     	itemPool.add(new Usable("Round Drop", 0, 1, 0, 0));
     	
     	//add equipable items to pool - name, class, dmg, amr, str, agi, int
     	//headgear
     		//str
     	itemPool.add(new Equipable("Ruby Armet", 1, 0, 0, 1, 5, 0, 0));
     	itemPool.add(new Equipable("Circlet", 1, 0, 0, 4, 10, 0, 1));
     	itemPool.add(new Equipable("Amulet Helm", 1, 0,  0, 5, 15, 0, 2));
     		//agi
     	itemPool.add(new Equipable("Bandana", 1, 0, 0, 1, 0, 5, 0));
     	itemPool.add(new Equipable("Tiger Cap", 1, 0, 0, 5, 0, 10, 0));
     	itemPool.add(new Equipable("Needle Helm", 1, 0, 5, 8, 0, 15, 0));
     		//int
     	itemPool.add(new Equipable("Duck Helmet", 1, 0, 0, 2, 0, 0, 5));
     	itemPool.add(new Equipable("Hair Ribbon", 1, 0, 0, 4, 0, 0, 10));
     	itemPool.add(new Equipable("Faerie Crown", 1, 0, 0, 5, 5, 2, 15));
     	
     	//armor
     		//str
     	itemPool.add(new Equipable("Ruby Vest", 1, 1, 0, 4, 5, 0, 2));
     	itemPool.add(new Equipable("Magical Armor", 1, 1, 0, 7, 10, 0, 5));
     	itemPool.add(new Equipable("Vest Guard", 1, 1, 0, 10, 15, 0, 0));
     	
     		//agi
     	itemPool.add(new Equipable("Flower Suit", 1, 1, 0, 3, 0, 10, 1));
     	itemPool.add(new Equipable("Kung Fu Dress", 1, 1, 0, 6, 1, 15, 0));
     	itemPool.add(new Equipable("Tiger Bikini", 1, 1, 10, 10, 0, 20, 5));
     	
     		//int
     	itemPool.add(new Equipable("Midge Robe", 1, 1, 0, 3, 1, 0, 3));
     	itemPool.add(new Equipable("Faerie Cloak", 1, 1, 0, 9, 4, 0, 10));
     	itemPool.add(new Equipable("Vampire Cape", 1, 1, 12, 11, 1, 5, 12));
     	
     	//accessory
     		//str
     	itemPool.add(new Equipable("Power Wrist", 1, 2, 4, 1, 2, 1, 0));
     	itemPool.add(new Equipable("Golem Ring", 1, 2, 8, 1, 3, 0, 0));
     	itemPool.add(new Equipable("Dragon Ring", 1, 2, 12, 2, 5, 5, 0));
     	
     		//agi
     	itemPool.add(new Equipable("Ninja Gloves", 1, 2, 5, 0, 1, 8, 0));
     	itemPool.add(new Equipable("Wolf's Band", 1, 2, 10, 0, 1, 13, 0));
     	//itemPool.add(new Equipable("Dragon Ring", 1, 0, 3, 1, 0, 3)); nadagdag na
     		
     		//int
     	itemPool.add(new Equipable("Amulet Ring", 1, 2, 2, 1, 2, 0, 4));
     	itemPool.add(new Equipable("Faerie's Ring", 1, 2, 2, 1, 3, 1, 7));
     	itemPool.add(new Equipable("Imp's Ring", 1, 2, 10, 1, 3, 2, 10));
     	
     	//weapon
     		//str
     	itemPool.add(new Equipable("Herald Sword", 1, 3, 10, 0, 1, 1, 0));
     	itemPool.add(new Equipable("Dragon Buster", 1, 3, 21, 0, 2, 1, 1));
     	itemPool.add(new Equipable("Excalibur", 1, 3, 9999, 0, 20, 20, 20));
     	
     		//agi
     	itemPool.add(new Equipable("Moogle Claws", 1, 3, 10, 1, 1, 3, 1));
     	itemPool.add(new Equipable("Hyper Fist", 1, 3, 15, 1, 0, 5, 1));
     	itemPool.add(new Equipable("Dragon Claws", 1, 3, 21, 3, 1, 10, 2));
     	
     		//int
     	itemPool.add(new Equipable("Fork of Hope", 1, 3, 11, 1, 1, 1, 5));
     	itemPool.add(new Equipable("Elf's Harpoon", 1, 3, 15, 2, 2, 2, 5));
     	itemPool.add(new Equipable("Valkyrian", 1, 3, 30, 5, 2, 2, 10));
    ...
    public void init(GameContainer container) throws SlickException {
    	...
    	mainMenuBG = new Image("images/mainmenuBG.png");
    	castleBenj = new Image("images/castlebenjful.png");
    	...
    	Image [] cast = {new Image("images/casting1.png"), new Image("images/casting2.png"), new Image("images/casting3.png")};
    	casting = new Animation(cast, duration5, true);
    	
    	Image[] fcast = {new Image("images/casting3.png"), new Image("images/casting4.png"), new Image("images/casting5.png")};
